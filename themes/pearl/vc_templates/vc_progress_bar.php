...
pearl_add_element_style('progress_bar', $atts['style']);

extract( $atts );
wp_enqueue_script( 'waypoints' );

$el_class = $this->getExtraClass( $el_class ) . $this->getCSSAnimation( $css_animation );
$el_class .= ' stm_progress_bar_' . $atts['style'];
...
foreach ( $graph_lines_data as $line ) {
	...
	$output .= '<small class="vc_label"' . $line['txtcolor'] . ' data-label="' . $percentage_value . '">' . $line['label'] . $unit . '</small>';
