...
$type = 'Pearl_Widget_Popular_Posts';
$args = array(
	'before_widget' => '<aside class="widget widget-default stm_widget_popular_posts stm_widget_popular_posts_' . $atts['style'] . ' ' . $css_class . ' mbdc">',
	'after_widget'  => '</aside>',
