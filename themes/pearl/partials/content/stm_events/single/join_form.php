...
if ($participants < $max_participants):
    ...
    if (time() < $date_start and !empty($date_start)): ?>
        <div class="stm_single_event__form stm_event_<?php echo intval($id); ?>"
            ...
            <form action="" method="post">
                ...
                <h3><?php esc_html_e('Join the event', 'pearl'); ?></h3>
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            <input type="text"
                                   name="name"
                                   placeholder="<?php esc_attr_e('Name *', 'pearl') ?>"/>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            <input type="email"
                                   name="email"
                                   placeholder="<?php esc_attr_e('Email *', 'pearl') ?>"/>
                        </div>
                    </div>
                </div>
                <div class="row stm_mgb_40">
                    <div class="col-md-6">
                        <div class="form-group">
                            <input type="text"
                                   name="phone"
                                   placeholder="<?php esc_attr_e('Phone', 'pearl') ?>"/>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                ...
                <div class="stm_flex stm_flex_center stm_flex_last form_actions">
                    ...
                    <a href="#"
                       ...
                       class="btn btn_primary btn_solid btn_loading <?php echo esc_attr($btn); ?>" disabled>
                        <span><?php esc_html_e('Join the event', 'pearl'); ?></span>
