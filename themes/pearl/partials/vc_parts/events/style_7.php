   ...
   <?php the_title_attribute(); ?>
	...
	<?php if(!empty($date) and $time): ?>
        <div class="stm_event_single_list__alone hasDate ttc">
            <i class="__icon icon_25px mtc stmicon-church-calendar"></i>
    ...
    <div class="stm_event_single_list__alone hasButton">
        <span class="btn btn_outline btn_secondary btn_icon-right">
            <?php echo sanitize_text_field($link_text); ?>
            <i class="stmicon-church-chevron-right btn__icon"></i>
        </span>
    </div>
</a>