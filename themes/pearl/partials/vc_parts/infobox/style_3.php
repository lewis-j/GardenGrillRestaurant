        ...
        <div class="stm_infobox__content wtc mbc">
            ...
            if(!empty($url)): ?>
                <p class="text-center">
                    ...
                    <?php if(!empty($link_title)): ?><?php echo sanitize_text_field($link_title); ?><?php else : ?><?php esc_html_e('Shop now', 'pearl'); ?><?php endif; ?> <span class="stmicon-church-chevron-right"></span>
                    </a>
                </p>
            <?php endif; ?>
        </div>
