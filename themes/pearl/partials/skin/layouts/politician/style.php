...
@media (max-width: 1023px)  {
    ...
    body.stm_layout_politician.stm_header_style_11 .stm-navigation__default > ul > li.active .stm_mobile__dropdown:after {
        top: 100%;
        left: 100%;
        transform: rotate(180deg);
    ...
    .stm-navigation__default .stm_megamenu>ul>li .stm_mobile__dropdown {
        display: none;
    }
